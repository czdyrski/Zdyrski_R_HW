...
teosinte_chrom_1_hyphen.txt <- paste(teosinte_chrom_1.txt[1:3], teosinte_chrom_1_hyphen.txt[4:978])

teosinte_chrom_1.txt_three_col <- teosinte_chrom_1.txt[1:3]

teosinte_chrom_1_hyphen.txt <- c(teosinte_chrom_1.txt_three_col, teosinte_chrom_1_hyphen.txt)
...
```{r}
maize_chrom_1_hyphen.txt <- gsub("A", "B", maize_chrom_1.txt, ignore.case=FALSE, extended=TRUE) 

maize_chrom_1_hyphen.txt <- maize_chrom_1.txt[maize_chrom_1.txt=="A"] <- "B"
maize_chrom_1_hyphen.txt <- as.data.frame(maize_chrom_1_hyphen.txt)
